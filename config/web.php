...
$config = [
    ...
    'modules' => [
        'yii2images' => [
            ...
            'placeHolderPath' => '@webroot/upload/placeholder/placeholder.png', // if you want to get placeholder when image not exists, string will be processed by Yii::getAlias
